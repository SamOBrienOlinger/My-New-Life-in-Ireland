    ...
    <main className="about-page" lang={language} dir={dir}>
      ...
      <footer className="site-footer about-footer">
        <div className="site-footer-brand">
          <strong>{t.siteName}</strong><span>{t.tagline}</span><a href="../">{a.back}</a>
        </div>
