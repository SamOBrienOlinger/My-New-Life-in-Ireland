  ...
  if (started && character) {
    return (
      <main className="journey-shell" lang={language} dir={dir}>
        ...
        <footer className="site-footer journey-footer"><div className="site-footer-content"><p><strong>{t.siteName}</strong> - {t.tagline}</p><p><a href="https://samobrienolinger.github.io/SamOBrienOlinger/" target="_blank" rel="noreferrer">Sam Tim Solutions</a></p><p className="site-footer-copyright">{t.copyright}</p></div></footer>
      </main>
    );
  }
