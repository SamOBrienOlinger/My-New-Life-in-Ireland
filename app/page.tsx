...
export default function Home() {
  ...
  return <main>
    <section className="hero-section hero-section-expanded" id="top">
      ...
      <div className="hero-content hero-content-expanded"><p className="eyebrow">An interactive journey through Ireland’s migration system</p><h1>Starting your new life in Ireland is not one simple decision. It is a chain of difficult decisions.</h1><div className="hero-copy"><p>You cannot control the circumstances, only try to make the best choices in front of you.</p><p>Pick one of twelve fictional people. Understand how your journey unfolds as you prepare to depart, arrive at the border and navigate life in Ireland.</p><div className="hero-questions" aria-label="Questions explored in each journey"><span><CheckCircle2 aria-hidden="true" />Who are you?</span><span><CheckCircle2 aria-hidden="true" />What’s happening to your life?</span><span><CheckCircle2 aria-hidden="true" />How does the Irish immigration system actually affect you?</span></div></div><div className="hero-actions"><a className="primary-button hero-button" href="#route-finder">Find a journey <ArrowRight size={18} aria-hidden="true" /></a><a className="quiet-button hero-secondary" href="resources/"><BookOpen size={18} aria-hidden="true" />Explore practical information</a></div><div className="hero-proof" aria-label="Experience summary"><span><strong>12</strong><small>people</small></span><span><strong>6</strong><small>route types</small></span><span><strong>40</strong><small>decisions</small></span><span><strong>1</strong><small>Irish context</small></span></div></div>
    </section>
